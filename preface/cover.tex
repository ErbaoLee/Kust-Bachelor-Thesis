...
\newfontfamily{\宋体黑}[AutoFakeBold]{SimSun}
\newfontfamily{\songti}{SimSun}
\newfontfamily{\huawen}{STXinwei}
\newfontfamily{\hei}{SimHei}

\newfontfamily{\TNR}{Times New Roman}
\newfontfamily{\TNRB}[AutoFakeBold]{Times New Roman}
...
%昆明理工大学 \par
\includegraphics[scale=0.18]{kust.png}\\
}
\vspace{10pt}
{
\hei
\fontsize{44pt}{55pt}\selectfont
毕\thickspace 业\thickspace 设\thickspace 计\thickspace{\宋体黑（}\thickspace 论\thickspace 文\thickspace{\宋体黑 ）}
\\[50mm]
}
\end{center}
}
